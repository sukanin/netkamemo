<%@ Page Language="C#" AutoEventWireup="true" CodeFile="select_approver_1.aspx.cs" Inherits="select_approver_1" %>
                ...
                <MasterTableView Width="100%" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="ID">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn DataField="ID" HeaderText="ID" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="80" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <%# "<a href='#' onclick=\"window.opener.document.forms[0].ctl00_ctl00_ContentPlaceHolder1_ContentPlaceHolder3_Approver1ConfirmBy.value='" + Eval("Username").ToString() + "';window.close();\">select</a>"%>
                            </ItemTemplate>
