<%@ Page Title="" Language="C#" MasterPageFile="~/DotBambooEditGrid.master" AutoEventWireup="true" CodeFile="TodolistMemoRequests.aspx.cs" Inherits="TodolistPurchaseRequests" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" Width="900px" runat="server" ID="RadGrid1" MasterTableView-PageSize="20" AllowPaging="True" AllowSorting="true" OnNeedDataSource="RadGrid1_NeedDataSource" OnItemCommand="RadGrid1_ItemCommand" Culture="th-TH" Height="600px">
                <MasterTableView Width="900px" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="ID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridButtonColumn ButtonType="ImageButton" Text="Delete" UniqueName="Delete" CommandName="Delete" HeaderStyle-Width="28px" ConfirmText="Do you want to cancel this PR request?" Exportable="false" Visible="false"></telerik:GridButtonColumn>
