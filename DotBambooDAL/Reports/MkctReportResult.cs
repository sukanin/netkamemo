...
namespace DotBambooDAL.Reports
{
    ...
    public class MkctApprovePRItemResult
    {
    ...
    public class MkctApprovePRItemDataQuery : BaseQueryData<MkctApprovePRItemResult>
    {
  ...
  if(b.purchase_item_seq='1','CT','') as 'PurchaseOrganization',
  ...
  if(b.purchase_item_pm_order <> '',b.purchase_item_pm_order, a.pm_order) as 'PMOrder' ";
        ...
        {
            string sql = @"from mkct_purchase as a
left join mkct_purchase_item as b on a.purchase_id = b.purchase_id
left join mkct_cost_center as c on a.cost_center=c.code ";
            return sql;
        }
    }
    ...
    public class MkctAllPurchaseRequestResult
    {
    ...
    public class MkctAllPurchaseRequestDataQuery : BaseQueryData<MkctAllPurchaseRequestResult>
    {
        protected override string SelectClause()
        {
            return @"select
...
if(isnull(b.approve_confirm_date),'',if(b.purchase_order_status=6 && b.cancel_reject_status=0,b.approve_confirm_date,'')) as 'PoApprovedDate' ";
        ...
        {
            string sql = @"from mkct_purchase as a
left join mkct_purchase_order as b on substr(a.purchase_number,6,10) = b.purchase_number 
left join mkct_purchase_item as c on a.purchase_id = c.purchase_id and c.purchase_item_seq = 1 
left join mkct_vendor as d on c.vendor=d.vendor_code ";
            return sql;
        }
    }
    #endregion
    ...
    public class MkctTodoPurchaseRequestResult
    {
        public string ID { get; set; }
        public DateTime PurchaseDate { get; set; }
        public string PurchaseNumber { get; set; }
    ...
    public class MkctTodoPurchaseRequestDataQuery : BaseQueryData<MkctTodoPurchaseRequestResult>
    {
        protected override string SelectClause()
        {
            return @"select
...
if(isnull(b.approve_confirm_date),'',if(b.purchase_order_status=6 && b.cancel_reject_status=0,b.approve_confirm_date,'')) as 'PoApprovedDate' ";
        ...
        {
            string sql = @"from mkct_purchase as a
left join mkct_purchase_order as b on substr(a.purchase_number,5,10) = b.purchase_number 
left join mkct_purchase_item as c on a.purchase_id = c.purchase_id and c.purchase_item_seq = 1 
left join mkct_vendor as d on c.vendor=d.vendor_code
left join mkct_purchase_todo as e on a.purchase_id = e.purchase_id ";
            return sql;
        }
    }
    #endregion
    ...
    public class MkctAllApprovePORequestResult
    {
        public string ID { get; set; }
        public DateTime PurchaseDate { get; set; }
    ...
    public class MkctAllApprovePORequestDataQuery : BaseQueryData<MkctAllApprovePORequestResult>
    {
        protected override string SelectClause()
        {
            return @"select
