...
namespace DotBambooDAL.Reports
{
    ...
    public class CartonApprovePRItemResult
    {
    ...
    public class CartonApprovePRItemDataQuery : BaseQueryData<CartonApprovePRItemResult>
    {
  ...
  if(b.purchase_item_pm_order <> '',b.purchase_item_pm_order, a.pm_order) as 'PMOrder' ";
        ...
        {
            string sql = @"from carton_purchase as a
left join carton_purchase_item as b on a.purchase_id = b.purchase_id
left join carton_cost_center as c on a.cost_center=c.code ";
            return sql;
        }
    }
    ...
    public class CartonAllPurchaseRequestResult
    {
    ...
    public class CartonAllPurchaseRequestDataQuery : BaseQueryData<CartonAllPurchaseRequestResult>
    {
        protected override string SelectClause()
        {
            return @"select
...
if(isnull(b.approve_confirm_date),'',if(b.purchase_order_status=6 && b.cancel_reject_status=0,b.approve_confirm_date,'')) as 'PoApprovedDate' ";
        ...
        {
            string sql = @"from carton_purchase as a
left join carton_purchase_order as b on substr(a.purchase_number,5,10) = b.purchase_number 
left join carton_purchase_item as c on a.purchase_id = c.purchase_id and c.purchase_item_seq = 1 
left join carton_vendor as d on c.vendor=d.vendor_code ";
            return sql;
        }
    }
    #endregion
    ...
    public class CartonTodoPurchaseRequestResult
    {
        public string ID { get; set; }
        public DateTime PurchaseDate { get; set; }
        public string PurchaseNumber { get; set; }
    ...
    public class CartonTodoPurchaseRequestDataQuery : BaseQueryData<CartonTodoPurchaseRequestResult>
    {
        protected override string SelectClause()
        {
            return @"select
...
left join carton_purchase_item as c on a.purchase_id = c.purchase_id and c.purchase_item_seq = 1 
left join carton_vendor as d on c.vendor=d.vendor_code
left join carton_purchase_todo as e on a.purchase_id = e.purchase_id ";
            return sql;
        }
    }
    #endregion
    ...
    public class CartonAllApprovePORequestResult
    {
        public string ID { get; set; }
        public DateTime PurchaseDate { get; set; }
    ...
    public class CartonAllApprovePORequestDataQuery : BaseQueryData<CartonAllApprovePORequestResult>
    {
        protected override string SelectClause()
        {
            return @"select
